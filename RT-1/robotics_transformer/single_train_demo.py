"""
robotic transformer(https://github.com/google-research/robotics_transformer)的single node训练代码,
...
def get_args():
    ...
    parser.add_argument('--dataset_dirs', '-d', help='dataset path', default="/home/utseus/RT-1/robotics_transformer/data/")
    ...
    parser.add_argument('--checkpoints_saved_dir', '-csd', help='模型保存目录', default="/home/utseus/RT-1/robotics_transformer/model/", type=str)
...
if __name__ == '__main__':
    ...
    global_batch_size = args.single_gpu_batch_size
    ...
    for epoch in range(1, args.training_epoch):
        ...
        for data in tqdm(train_ds):
            ...
            loss, _ = train_one_step(network, train_observation, train_labels, network_state, optimizer)
            total_loss += loss
            step += 1
